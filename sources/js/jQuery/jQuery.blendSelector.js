(function($){
            ...
            $.batch = $.batch || function ( queue, size, current, timeout, method, callback, _nextPort ){
                ...
                if ($.isFunction(method)) {
                    ...
                    console.log("Error: tbc.Tree().batch(...). arguments[4] must be a function or a method of tbc.Tree();");
                }
            ...
            $.fn.blendSelector = function( settings ) {
                ...
                var id  = "blendSelectorIframe_" + new Date().getTime(),
                    ...
                    iframe = $('<iframe id="' + id + '_iframe" name="' + id + '_iframe" src="about:blank" frameborder="0" hidefocus="true" scrolling="no" style="position:relative; width:100%; height:100%; " allowTransparency="true"></iframe>').appendTo(html),
                    height = Math.max(
