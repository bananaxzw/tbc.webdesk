<div class="msSetPanel">
    ...
    <table class="scform" style="font-size:12px;width:96%;margin:0 auto 10px;">
        <tr>
            ...
            <td>
                <div class="scform_cell"><input id="msSetInput1" name="userParam" required type="text"/> <em class="sctip_right hide"></em>&nbsp;&nbsp;<span
        ...
        <tr>
            ...
            <td>
                <div class="scform_cell"><input id="msSetInput2" name="passwordParam" required type="text"/> <em class="sctip_right hide"></em>&nbsp;&nbsp;<span
        ...
        <tr>
            ...
            <td>
                <div class="scform_cell"><textarea cols="65" rows="5" name="extraParam"></textarea></div>
            </td>
        </tr>
    </table>
